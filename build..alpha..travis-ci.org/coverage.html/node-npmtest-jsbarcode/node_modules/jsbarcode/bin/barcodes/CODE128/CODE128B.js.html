...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsbarcode/node_modules/jsbarcode/bin/barcodes/CODE128/CODE128B.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsbarcode/node_modules/jsbarcode/bin/barcodes/CODE128/CODE128B.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsbarcode/node_modules/jsbarcode/bin/barcodes/CODE128/</a> &#187; CODE128B.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >	function CODE128B(string, options) {</span>
<span class="cstat-no" title="statement not covered" >		_classCallCheck(this, CODE128B);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		return _possibleConstructorReturn(this, _CODE.call(this, String.fromCharCode(209) + string, options));</span>
	}
&nbsp;
	CODE128B.prototype.valid = <span class="fstat-no" title="function not covered" >function valid() {</span>
<span class="cstat-no" title="statement not covered" >		return this.data.search(/^[\x20-\x7F\xC8-\xCF]+$/) !== -1;</span>
	};
&nbsp;
	return CODE128B;
}(_CODE3.default);
