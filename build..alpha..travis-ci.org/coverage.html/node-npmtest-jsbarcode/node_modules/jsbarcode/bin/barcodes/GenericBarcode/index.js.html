...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsbarcode/node_modules/jsbarcode/bin/barcodes/GenericBarcode/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsbarcode/node_modules/jsbarcode/bin/barcodes/GenericBarcode/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsbarcode/node_modules/jsbarcode/bin/barcodes/GenericBarcode/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >	function GenericBarcode(data, options) {</span>
<span class="cstat-no" title="statement not covered" >		_classCallCheck(this, GenericBarcode);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		return _possibleConstructorReturn(this, _Barcode.call(this, data, options)); </span>// Sets this.data and this.text
	}
&nbsp;
	// Return the corresponding binary numbers for the data provided
&nbsp;
&nbsp;
	GenericBarcode.prototype.encode = <span class="fstat-no" title="function not covered" >function encode() {</span>
...
&nbsp;
&nbsp;
	GenericBarcode.prototype.valid = <span class="fstat-no" title="function not covered" >function valid() {</span>
